...
public class CloudSDKHandler {
    ...
    @Before("execution(public * com.efuav.sdk.cloudapi.*.api.*.*(com.efuav.sdk.config.version.GatewayManager, ..))")
    ...
    @Before("execution(public * com.efuav.sdk.cloudapi.*.api.*.*(com.efuav.sdk.config.version.GatewayManager, com.efuav.sdk.common.BaseModel+))")
    public void checkRequest(JoinPoint point) {
        Common.validateModel((BaseModel) point.getArgs()[1], (GatewayManager) point.getArgs()[0]);
    }

    @AfterReturning(value = "execution(public com.efuav.sdk.common.HttpResultResponse+ com.efuav.sdk.cloudapi.*.api.*.*(..))", returning = "response")
